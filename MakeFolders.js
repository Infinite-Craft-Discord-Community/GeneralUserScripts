...
(function() {
    ...
    function existsFolder(fileName) {
        ...
        for (let f of document.querySelectorAll(".folder")) {
                        if (f.children[0].children[0].textContent == fileName )
                            return true;
                    }
           return false;
    ...
    function initTheAlphabeth() {
        ...
        let alphabetData = {
            a: [{
                    ...
                    "style": "translate: 0px; z-index: 46; height: 43px; width: 80px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(0, 127, 255); border-width: 2px; --shadow-rgb: rgb(0,127,255);"
                }, {
                    "emoji": "🅱️",
                    "text": "\"b\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(139, 69, 19) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 54; height: 43px; width: 81px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(139, 69, 19); border-width: 2px; --shadow-rgb: rgb(139,69,19);"
                }, {
                    "emoji": "🇨",
                    "text": "\"c\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(220, 20, 60) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 62; height: 43px; width: 61px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(220, 20, 60); border-width: 2px; --shadow-rgb: rgb(220,20,60);"
                }, {
                    "emoji": "🇩",
                    "text": "\"d\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(240, 225, 48) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 66; height: 43px; width: 64px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(240, 225, 48); border-width: 2px; --shadow-rgb: rgb(240,225,48);"
                }, {
                    "emoji": "🇪",
                    "text": "\"e\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(80, 200, 120) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 74; height: 43px; width: 60px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(80, 200, 120); border-width: 2px; --shadow-rgb: rgb(80,200,120);"
                }, {
                    "emoji": "🇫",
                    "text": "\"f\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(217, 2, 125) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 78; height: 43px; width: 57px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(217, 2, 125); border-width: 2px; --shadow-rgb: rgb(217,2,125);"
                }, {
                    "emoji": "🇬",
                    "text": "\"g\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(128, 128, 128) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 82; height: 43px; width: 63px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(128, 128, 128); border-width: 2px; --shadow-rgb: rgb(128,128,128);"
                }, {
                    "emoji": "🤔",
                    "text": "\"h\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(223, 115, 255) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 90; height: 43px; width: 81px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(223, 115, 255); border-width: 2px; --shadow-rgb: rgb(223,115,255);"
                }, {
                    "emoji": "👁️",
                    "text": "\"i\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(75, 0, 130) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 95; height: 43px; width: 75px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(75, 0, 130); border-width: 2px; --shadow-rgb: rgb(75,0,130);"
                }, {
                    "emoji": "🇯",
                    "text": "\"j\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(0, 168, 107) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 99; height: 43px; width: 53px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(0, 168, 107); border-width: 2px; --shadow-rgb: rgb(0,168,107);"
                }, {
                    "emoji": "👍",
                    "text": "\"k\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(195, 176, 145) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 103; height: 43px; width: 78px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(195, 176, 145); border-width: 2px; --shadow-rgb: rgb(195,176,145);"
                }, {
                    "emoji": "👍",
                    "text": "\"l\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(220, 208, 255) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 107; height: 43px; width: 73px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(220, 208, 255); border-width: 2px; --shadow-rgb: rgb(220,208,255);"
                }, {
                    "emoji": "🆖",
                    "text": "\"n\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(0, 0, 128) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 111; height: 43px; width: 80px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(0, 0, 128); border-width: 2px; --shadow-rgb: rgb(0,0,128);"
                }, {
                    "emoji": "🇲",
                    "text": "\"m\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(255, 0, 144) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 112; height: 43px; width: 72px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(255, 0, 144); border-width: 2px; --shadow-rgb: rgb(255,0,144);"
                }, {
                    "emoji": "👌",
                    "text": "\"o\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(255, 165, 0) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 116; height: 43px; width: 73px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(255, 165, 0); border-width: 2px; --shadow-rgb: rgb(255,165,0);"
                }, {
                    "emoji": "🅿️",
                    "text": "\"p\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(160, 32, 240) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 120; height: 43px; width: 81px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(160, 32, 240); border-width: 2px; --shadow-rgb: rgb(160,32,240);"
                }, {
                    "emoji": "❓",
                    "text": "\"q\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(81, 65, 79) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 124; height: 43px; width: 72px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(81, 65, 79); border-width: 2px; --shadow-rgb: rgb(81,65,79);"
                },
                {
                    "emoji": "🤔",
                    "text": "\"r\"",
                    ...
                    "style": "translate: 0px; z-index: 128; height: 43px; width: 78px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(255, 0, 0); border-width: 2px; --shadow-rgb: rgb(255,0,0);"
                }, {
                    "emoji": "🐍",
                    "text": "\"s\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(250, 128, 114) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 132; height: 43px; width: 78px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(250, 128, 114); border-width: 2px; --shadow-rgb: rgb(250,128,114);"
                }, {
                    "emoji": "🤔",
                    "text": "\"z\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(0, 20, 168) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 136; height: 43px; width: 80px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(0, 20, 168); border-width: 2px; --shadow-rgb: rgb(0,20,168);"
                }, {
                    "emoji": "🕒",
                    "text": "\"t\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(0, 128, 128) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 140; height: 43px; width: 77px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(0, 128, 128); border-width: 2px; --shadow-rgb: rgb(0,128,128);"
                }, {
                    "emoji": "👍",
                    "text": "\"u\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(4, 55, 242) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 145; height: 43px; width: 78px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(4, 55, 242); border-width: 2px; --shadow-rgb: rgb(4,55,242);"
                }, {
                    "emoji": "❌",
                    "text": "\"x\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(241, 180, 47) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 149; height: 43px; width: 80px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(241, 180, 47); border-width: 2px; --shadow-rgb: rgb(241,180,47);"
                }, {
                    "emoji": "🤔",
                    "text": "\"y\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(255, 255, 0) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 153; height: 43px; width: 80px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(255, 255, 0); border-width: 2px; --shadow-rgb: rgb(255,255,0);"
                }, {
                    "emoji": "🤔",
                    "text": "\"z\"",
                    "span": true,
                    "spanCss": "color: color-mix(in srgb, rgb(0, 20, 168) 40%, rgb(255, 255, 255));",
                    "style": "translate: 0px; z-index: 157; height: 43px; width: 80px; border-radius: 10px; animation: auto ease 0s 1 normal none running none; transition: none 0s ease 0s; box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) color-mix(in srgb,var(--shadow-rgb),  transparent 70%),\n             inset 0 0 20px  color-mix(in srgb, var(--shadow-rgb), transparent 70%); border-color: rgb(0, 20, 168); border-width: 2px; --shadow-rgb: rgb(0,20,168);"
                }
            ]
        };
        ...
        if (folders.includes("alphabets")) {
            ...
            if (!("alphabets" in foldersData))
                foldersData["alphabets"] = [];

            for (let elm of alpbabethFolder) {
                console.log("elm", elm);
                console.log("filterd:", foldersData["alphabets"].filter(item => item.text == elm.text));
    ...
    function getElementToSave(cloneElement, discovered = false) {
        ...
        let span = false;
        console.log("text contente:", cloneElement.textContent);
        let textContent = cloneElement.textContent.slice(1);
    ...
    function AtIntersection(element1, element2) {
        ...
        if (
            ...
            cloneElement.addEventListener('mousedown', (e) => {
                ...
                if (e.shiftKey) {
                    foldersData[element2.children[0].children[0].textContent] =
                        foldersData[element2.children[0].children[0].textContent].filter(item => item.text != element.text);
                    localStorage.setItem("folderStructure", JSON.stringify(foldersData));
            ...
            // Elements touch or intersect
            // Your code to handle this scenario
        } else {
            // Elements do not touch or intersect
            // Your code to handle this scenario
        }
    ...
    function buildFolder(localFolder = null) {
        ...
        if (localFolder == null) {
            ...
            /*
                   if(localFolder!=null && parentSidebar.contains(currentFolder))
                     {

                        parentSidebar.removeChild(currentFolder);
                     }
                     */
            ...
            minimizeMaximize.addEventListener("mouseover",
                function() {
                    console.log("over maximize");
            ...
            minimizeMaximize.addEventListener("mouseout",
                function() {
            ...
            cleanP.addEventListener("mouseover",
                function() {
            ...
            deleteFolderP.addEventListener("mouseover",
                function() {
            ...
            cleanP.addEventListener("mouseout",
                function() {
            ...
            deleteFolderP.addEventListener("mouseout",
                function() {
                    // cleanP.style.color="transparent";
            ...
            deleteFolderP.addEventListener("click", function() {
                confirmPrompt(function() {
                    for (let f of document.querySelectorAll(".folder")) {
                        if (f.children[0].children[0].textContent == localFolder.children[0].children[0].textContent)
                            parentSidebar.removeChild(f);
                    }
                    ...
                    //buildFolder(localFolder);
                    if (ParentSource.contains(ThemeButton))
                        ParentSource.removeChild(ThemeButton);
    ...
    function injectCSS() {
        ...
        .theme_settings_opt {
         ...
         .folders {
            ...
            scrollbar-width: none; /* Firefox */
            -ms-overflow-style: none;  /* Internet Explorer 10+ */}
         .folders::-webkit-scrollbar { /* WebKit */
            width: 0;
            height: 0;}
         ...
         .folderName
         {
          ...
          .folder {
            ...
            scrollbar-width: none; /* Firefox */
            -ms-overflow-style: none;  /* Internet Explorer 10+ */}
         .folder::-webkit-scrollbar { /* WebKit */
            width: 0;
            height: 0;}
